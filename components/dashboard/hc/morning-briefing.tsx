...
export function MorningBriefing({ briefing }: MorningBriefingProps) {
  return (
    <section
      className="yd-morning-briefing yd-command-prepared mb-4 min-w-0 rounded-[20px] border border-[rgba(180,198,218,0.28)] bg-white px-5 py-3.5 md:px-6 md:py-4"
    ...
    >
      <div className="flex flex-col gap-3.5 sm:flex-row sm:items-start sm:justify-between">
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1.5 text-[13px] leading-relaxed text-[#5e7389]">{briefing.subline}</p>
