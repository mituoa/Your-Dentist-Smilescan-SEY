...
import { resolveWorkspaceSearchVisible } from "@/lib/app-shell/workspace-page-context";
...
/** Desktop — globale Praxis-Toolbar (kontextabhängige Suche). */
  ...
  return (
    <header className="yd-workspace-toolbar hidden shrink-0 md:block">
      <div className="yd-workspace-toolbar__shell">
        <div
          className={cn(
            "yd-workspace-toolbar__inner",
            !showSearch && "yd-workspace-toolbar__inner--no-search"
          )}
        >
