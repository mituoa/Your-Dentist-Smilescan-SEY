...
export const SITE_HEADLINE = "Your Dentist";
export const SITE_TAGLINE = "Neutral Practice Platform";

/** Full SEO description (meta description). */
...
/** Short line for link previews (Open Graph / Twitter). */
export const SITE_OG_DESCRIPTION =
  "Neutral Practice Platform — ruhige Infrastruktur für moderne Zahnarztpraxen.";

export const SITE_OG_IMAGE_ALT =
  "Your Dentist — Neutral Practice Platform: Logo auf hellem, ruhigem Hintergrund";
