...
export function ProtectedShell({ children, user, workspace, currentPath }: ProtectedShellProps) {
  ...
  const navItems = user.role === "doctor"
    ...
    : [
        { label: "Meine Aufgaben", path: "/my-tasks" },
        { label: "Profil", path: "/profile" },
      ];
            ...
            <nav className="px-4 py-6 space-y-1">
              ...
              <div className="pt-6 mt-6 border-t border-slate-200 dark:border-slate-800">
                ...
                <form action="/api/auth/logout" method="POST" className="mt-4">
                  <button
                    type="submit"
                    className="w-full flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-950/50 transition-colors"
                  >
